...
Read our free online book on [![Visual Studio Code Browser Debugging from the Ground Up](https://github.com/CloudIDEaaS/cloudideaas-vscode-debugger/raw/HEAD/Media/Book.png)](https://publications.lavedajones.com/vscode-debugger/index.html)
...
See [CHANGELOG.md](https://github.com/CloudIDEaaS/cloudideaas-vscode-debugger/blob/HEAD/CHANGELOG.md) for release history.
